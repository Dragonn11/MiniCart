...
export default function ProductDetailPage() {
  ...
  if (error || !product)
    return <div style={{ padding: '2rem', color: 'red' }}>Product not found.</div>;
      ...
      >
        ...
        <div>
          ...
          <button
            ...
            style={{
              background: product.stock > 0 ? '#1a73e8' : '#ccc',
              color: '#fff',
              border: 'none',
          ...
          {addToCart.isSuccess && (
            <p style={{ color: '#34a853', marginTop: '0.5rem' }}>Added to cart!</p>
          )}
        </div>
      </div>
    </div>
