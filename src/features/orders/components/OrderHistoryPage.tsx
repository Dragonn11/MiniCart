    ...
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          ...
          <button onClick={invalidateOrders}
            style={{ background: '#f8f9fa', border: '1px solid #ddd', padding: '0.5rem 1rem', borderRadius: 6, cursor: 'pointer' }}>
            ↻ Refresh
          </button>
        </div>
      </div>
      ...
      {data && data.data.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {data?.data.map((order) => (
            <div key={order.id} style={{ border: '1px solid #e0e0e0', borderRadius: 8, padding: '1.25rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                ...
                <span style={{
                  ...
                  padding: '0.25rem 0.75rem', borderRadius: 12, fontSize: '0.85rem', fontWeight: 600,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                {order.items.map((item) => (
                  <div key={item.productId} style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.9rem', color: '#555' }}>
              ...
              <div style={{ borderTop: '1px solid #e0e0e0', marginTop: '0.75rem', paddingTop: '0.75rem', textAlign: 'right', fontWeight: 'bold', fontSize: '1.1rem' }}>
